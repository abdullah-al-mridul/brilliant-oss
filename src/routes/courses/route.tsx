...
const COURSE_CATEGORIES = [
  {
    ...
    icon: (
      <div className="w-12 h-12 flex items-center justify-center shrink-0">
         <div className="relative w-full h-full flex items-center justify-center">
            ...
            {/* Top Layer */}
            <div className="absolute w-[85%] h-[55%] bg-[#a276ff] rounded-xl transform -skew-x-[20deg] -translate-y-[12px] flex items-center justify-center border-t border-[#c0a2ff] shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
    ...
    courses: [
      { id: "c1", title: "Thinking in Code", image: ArithmaticIMG, isNew: false },
      { id: "c2", title: "Programming with Variables", image: ScientificIMG, isNew: false },
      { id: "c3", title: "Thinking in Python", image: DataIMG, isNew: true },
      { id: "c4", title: "Programming with Functions", image: ArithmaticIMG, isNew: false },
      { id: "c5", title: "Functions in Python", image: ScientificIMG, isNew: true },
  ...
  },
  {
    ...
    courses: [
      ...
      { id: "d3", title: "Data Distributions", image: ScientificIMG, isNew: false },
        ...
        {COURSE_CATEGORIES.map((category, catIdx) => (
          <section key={category.id} className="w-full relative">
            ...
            <div className="relative w-full rounded-[24px] bg-[#f5f5f5] p-6 lg:p-8 border border-gray-100 shadow-[inset_0_0_10px_rgba(0,0,0,0.02)] overflow-hidden group">
              <div className={`swiper-button-next-${catIdx} hidden md:flex absolute font-bold w-10 h-10 bg-black text-white rounded-full shadow-lg items-center justify-center right-4 top-1/2 -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer`}>
